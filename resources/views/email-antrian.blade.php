                ...
                <tr>
                    <td class="one-column">
                        <table width="100%">
                            <tr>
                                <td class="inner-td">
                                    <p class="h2">Detail Antrian Anda</p>
                                </td>
                            </tr>
                        </table>
                    </td>
                        ...
                        <table width="100%">
                            <tr>
                                <td class="inner-td">
                                    ...
                                    <p class="item-text-center">{{ $antrian }}</p>
                                    <hr>
                                    <p>Berikut hasil dari no antrian anda pada tanggal : {{ date('Y-m-d') }}. Silahkan datang ke klinik lebih awal untuk menghindari antrian terlewat.</p>
