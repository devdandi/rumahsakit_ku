                            ...
                            <div class="ibox-body">
                                ...
                                <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <select name="send_to" class="form-control w-25" id="test">
                                                ...
                                                @foreach($get_user as $users)
                                                    <option id="idobats" value="{{ $users->id_user }}">{{ $users->name }} ( {{$users->level}} ) </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control w-50"  name="harga[]" id="harga"  type="text">
                                        </div>
                                    </div>
                                    <div class="add">
                                ...
                                <button id="duplicates" class="btn btn-primary">Tambah Obat Lain</button>
                            </div>
                        </div>
                        </div>
                    </div>
...
<script>
    $(document).ready( () => {
        ...
        // })
        $('#nama_obat').on('change', () => {
            // console.log($('#idobat').val())
            var data = "data="+$('#nama_obat').val()
            $.ajax({
                type: 'GET',
                url: '/dashboard/obat/check',
                data: data,
