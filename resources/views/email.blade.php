                        ...
                        <table width="100%">
                            <tr>
                                <td class="inner-td">
                                    ...
                                    <p class="item-text-center">Nama Pasien: {{ $data['nama'] }}</p>
                                    <p class="item-text-center">Telepon: {{ $data['telepon'] }}</p>
                                    <p class="item-text-center">Keluhan: {{ $data['keluhan'] }}</p>
                                    <p class="item-text-center">Dokter: {{ $data['dokter'] }}</p>
                                    <p class="item-text-center">Tanggal: {{ $data['date'] }}</p>
                                    <p class="item-text-center">Pesan: <br> {{ $data['pesan'] }}</p>
                                    <hr>
