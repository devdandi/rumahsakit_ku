                        ...
                        <table width="100%">
                            <tr>
                                <td class="inner-td">
                                    ...
                                    <p class="item-text-center">Nama : {{ $data['nama'] }}</p>
                                    <p class="item-text-center">Tanggal : {{ $data['date'] }}</p>
                                    ...
                                    <p><a href="http://localhost:8000/cancel/{{ $data['email'] }}" class="btn">Batalkan</a></p>
                                    ...
                                    <p><a href="http://localhost:8000/antrian/daftar/{{ $data['email'] }}/{{$data['date']}}" class="btn">Ambil Antrian</a></p>
