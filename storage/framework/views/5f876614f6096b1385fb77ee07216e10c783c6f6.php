                        ...
                        <table width="100%">
                            <tr>
                                <td class="inner-td">
                                    ...
                                    <p class="item-text-center">Nama Pasien: Dandi Ramdani</p>
                                    <p class="item-text-center">Telepon: 0895330534784</p>
                                    <p class="item-text-center">Keluhan: Paru-Paru</p>
                                    <p class="item-text-center">Dokter: Ramdani</p>
                                    <p class="item-text-center">Tanggal: 22-12-2000</p>
                                    <p class="item-text-center">Pesan: <br> dandi radasd</p>
                                    <hr>
...
</html><?php /**PATH D:\Project\rumahsakit\resources\views/invoice.blade.php ENDPATH**/ ?>