                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="ibox">
                            <div class="ibox-body text-center">
                                <div class="m-t-20">
                                    <img class="img-circle" src="<?php echo e(url('assets/img/admin-avatar.png')); ?>" />
                                </div>
                                <h5 class="font-strong m-b-10 m-t-10"><?php echo e($get_data[0]->name); ?></h5>
                                <div class="m-b-20 text-muted"><?php echo e($get_data[0]->level); ?></div>
                                                ...
                                                <ul class="media-list media-list-divider m-0">
                                                    <li class="media">
                                                        <a class="media-img" href="javascript:;">
                                                            <img class="img-circle" src="<?php echo e(url('assets/img/users/u1.jpg')); ?>" width="40" />
                                                        </a>
                                    ...
                                    <div class="tab-pane fade" id="tab-2">
                                        <form action="javascript:void(0)">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <p style="color: green"><?php echo e($get_data[0]->status); ?></p>
                                            </div>
                                            <div class="form-group">
...
<?php echo $__env->make('root.root', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\rumahsakit\resources\views/profile.blade.php ENDPATH**/ ?>