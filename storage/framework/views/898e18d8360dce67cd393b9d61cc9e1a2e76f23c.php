...
<head>
    ...
    <script src="<?php echo e(url('assets/vendors/jquery/dist/jquery.min.js')); ?>" type="text/javascript"></script>
    ...
    <link href="<?php echo e(url('assets/vendors/themify-icons/css/themify-icons.css')); ?>" rel="stylesheet" />
    <!-- PLUGINS STYLES-->
    <link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.5.0/css/bootstrap-datepicker.css" rel="stylesheet">
    <link href="<?php echo e(url('assets/vendors/jvectormap/jquery-jvectormap-2.0.3.css')); ?>" rel="stylesheet" />
    <!-- THEME STYLES-->
...
<body class="fixed-navbar">
    <div class="page-wrapper">
        ...
        <header class="header">
            <div class="page-brand">
                <a class="link" href="<?php echo e(url('/dashboard')); ?>">
                ...
                <ul class="nav navbar-toolbar">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right dropdown-menu-media">
                            <li class="dropdown-menu-header">
                                <div>
                                    ...
                                    <a class="pull-right" href="<?php echo e(url('/dashboard/mail')); ?>">Lihat Semua</a>
                                </div>
                            </li>
                            <li class="list-group list-group-divider scroller" data-height="240px" data-color="#71808f">
                                <div>
                                    <a class="list-group-item">
                                        <div class="media">
                                            <div class="media-img">
                                                <img src="<?php echo e(url('assets/img/')); ?>" />
                                            </div>
                    ...
                    <li class="dropdown dropdown-user">
                        <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                            <img src="<?php echo e(url('assets/img/admin-avatar.png')); ?>" />
                            <span></span><?php echo e(session()->get('email')); ?><i class="fa fa-angle-down m-l-5"></i></a>
                        <ul class="dropdown-menu dropdown-menu-right">
                            <!-- <a class="dropdown-item" href="<?php echo e(url('/dashboard')); ?>"><i class="fa fa-user"></i>Profile</a>
            ...
            <div id="sidebar-collapse">
                <div class="admin-block d-flex">
                    ...
                    <div class="admin-info">
                        <div class="font-strong"><?php echo e($get_data[0]->name); ?></div><small><?php echo e($get_data[0]->level); ?></small></div>
                </div>
                <ul class="side-menu metismenu">
                    ...
                    <?php if($get_data[0]->level == "Administrator"): ?>
                    ...
                    <?php if($get_data[0]->level == "Administrator" || $get_data[0]->level == "Dokter"): ?>
                    ...
                    <li>
                        ...
                        <ul class="nav-2-level collapse">
                            <li>
                                <a href="/dashboard/tambah/manufaktur/MF-<?php echo e(uniqid()); ?>-<?php echo e(date('Y')); ?>"><i class="ti-plus"></i> Tambah Manufaktur</a>
                            </li>
                            <li>
                    ...
                    <?php endif; ?>
                    <?php if($get_data[0]->level == "Farmasi" || $get_data[0]->level == "Dokter"): ?>
                    <li>
                        <a href="javascript:;"><i class="sidebar-item-icon fa fa-edit"></i>
                    ...
                    <?php endif; ?>
                    <?php if($get_data[0]->level == "Dokter"): ?>
                    <li>
                        <a href="javascript:;"><i class="sidebar-item-icon fa fa-edit"></i>
                    ...
                    <?php endif; ?>
                    <?php if($get_data[0]->level == "Administrator" || $get_data[0]->level == "Finance"): ?>
                    <li>
                    ...
                    <?php endif; ?>
                    <?php if($get_data[0]->level == "Administrator" || $get_data[0]->level == "Resepsionis"): ?>
                    <li>
    ...
    <!-- CORE PLUGINS-->
    <!-- <script src="<?php echo e(url('assets/vendors/jquery/dist/jquery.min.js')); ?>" type="text/javascript"></script> -->
    <script src="<?php echo e(url('assets/vendors/popper.js/dist/umd/popper.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(url('assets/vendors/bootstrap/dist/js/bootstrap.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(url('assets/vendors/metisMenu/dist/metisMenu.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(url('assets/vendors/jquery-slimscroll/jquery.slimscroll.min.js')); ?>" type="text/javascript"></script>
    <!-- PAGE LEVEL PLUGINS-->
    <script src="<?php echo e(url('assets/vendors/chart.js/dist/Chart.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(url('assets/vendors/jvectormap/jquery-jvectormap-2.0.3.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(url('assets/vendors/jvectormap/jquery-jvectormap-world-mill-en.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(url('assets/vendors/jvectormap/jquery-jvectormap-us-aea-en.js')); ?>" type="text/javascript"></script>
    <!-- CORE SCRIPTS-->
    <script src="<?php echo e(url('assets/js/app.min.js')); ?>" type="text/javascript"></script>
    <!-- PAGE LEVEL SCRIPTS-->
    
</body>

</html><?php /**PATH D:\Project\rumahsakit\resources\views/root/root.blade.php ENDPATH**/ ?>