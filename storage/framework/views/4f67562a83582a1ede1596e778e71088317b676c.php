  ...
  <div id="topbar" class="d-none d-lg-flex align-items-center fixed-top">
    <div class="container d-flex">
      <div class="contact-info mr-auto">
        <i class="icofont-envelope"></i> <a href="mailto:contact@example.com">dandiduit@gmail.com</a>
        <i class="icofont-phone"></i> +62895330534784
        <i class="icofont-google-map"></i> Bandung, Indonesia
      </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 d-flex align-items-stretch">
            <div class="content">
              <h3>Kenapa Memilih Apotek Kami ?</h3>
              <p>
              ...
              <div class="row">
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <h4>Bersetifikat</h4>
                    <p>Dokter dengan sertifikat yang resmi dan terpercaya.</p>
                  </div>
                </div>
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <h4>Konsultasi</h4>
                    <p>Konsultasi hingga masalah yang anda alami selesai.</p>
                  </div>
                </div>
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <h4>Galeri</h4>
                    <p>Merupakan foto bagaimana kami melayani masyarakat dengan baik.</p>
                  </div>
                </div>
              </div>
            </div><!-- End .content-->
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Pelayanan</h2>
          <p>Kami memliliki pelayanan yang baik sehingga pasien kami bisa puas dengan pelayanan kami.</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="icon-box">
              ...
              <h4><a href="">Resep Yang Terpercaya</a></h4>
      ...
      <div class="container">
        ...
        <form action="" method="post" role="form">
          ...
          <div class="form-row">
            ...
            <div class="col-md-4 form-group">
              <input type="tel" class="form-control" name="phone" id="phone" placeholder="Telepon" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
              <div class="validate"></div>
            </div>
          </div>
          <div class="form-row">
            ...
            <div class="col-md-4 form-group">
              <select name="keluhan" id="department" class="form-control">
                ...
                <?php $__currentLoopData = $get_spesialis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $spesialis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($spesialis->spesialis); ?>"><?php echo e($spesialis->spesialis); ?></option>
          ...
          <div class="mb-3">
            ...
            <?php if($message = Session::get('success')): ?>
              <div class="sent-message"><?php echo e($message); ?></div>
            <?php endif; ?>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              <br><br>
              <strong>WhatsApp:</strong> +62895330534784<br>
              <strong>Email:</strong> dandiduit@gmail.com<br>
            </p>
          </div>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Layanan Kami</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Spesialis Penyakit Dalam</a></li>
            </ul>
          </div>

          <div class="col-lg-4 col-md-6 footer-newsletter">
            <h4>Berlangganan</h4>
            <p>Dapatkan notifikasi dari kami</p>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        ...
        <div class="credits">
          ...
          Created by <a target="_blank" href="https://instagram.com/adulmicro">Dandi Ramdani</a>
        </div>
      </div>
...
</html><?php /**PATH D:\Project\rumahsakit\resources\views/front_page/index.blade.php ENDPATH**/ ?>