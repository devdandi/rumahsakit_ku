                                ...
                                <tr>
                                    <td class="inner-td">
                                        <table class="content">
                                            <tr>
                                                <!-- <td align="center">
                                                    <img class="center-logo" style="vertical-align: middle;" src="<?php echo e(url('/assets/img/admin-avatar.png')); ?>">
                                                </td> -->
                                            </tr>
                                        </table>
                                    </td>
                        ...
                        <table width="100%">
                            <tr>
                                <td class="inner-td">
                                    ...
                                    <p class="h3">Dokter menjadwal ulang pertemuan.</p>
                                    <p class="item-text-center">Nama : <?php echo e($data['nama']); ?></p>
                                    <p class="item-text-center">Tanggal : <?php echo e($data['date']); ?></p>
                                    <p class="item-text-center">Nomor Antrian : Belum Terdaftar</p>
                                    <p class="item-text-center">Jika anda menolak jadwal yang ditentukan oleh dokter, anda bisa membatalkannya.</p>
                                    <p><a href="http://localhost:8000/cancel/<?php echo e($data['email']); ?>" class="btn">Batalkan</a></p>
                                    <p>Jika anda menyetujui jadwal ini, silahkan abaikan tombol diatas. Terimakasih</p>
                                    
                                    <hr>
                                    <p>Silahkan ambil nomor antrian sesuai dengan tanggal yang ditentukan dokter, silahkan klik tombol di bawah ini jika hari ini anda ada jadwal dengan dokter.</p>
                                    <p><a href="http://localhost:8000/antrian/daftar/<?php echo e($data['email']); ?>/<?php echo e($data['date']); ?>" class="btn">Ambil Antrian</a></p>
...
</html><?php /**PATH D:\Project\rumahsakit\resources\views/email-tolak-date.blade.php ENDPATH**/ ?>