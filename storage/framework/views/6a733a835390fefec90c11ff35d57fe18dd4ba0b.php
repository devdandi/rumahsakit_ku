                        ...
                        <table width="100%">
                            <tr>
                                <td class="inner-td">
                                    ...
                                    <p class="center">Dokter berhak untuk penjadwalan ulang.</p>
                                </td>
                            </tr>
                        </table>
                    </td>
                        ...
                        <table width="100%">
                            <tr>
                                <td class="inner-td">
                                    ...
                                    <p class="h3">Informasi</p>
                                    <p class="item-text-center">Nama Pasien: <?php echo e($data['nama']); ?></p>
                                    <p class="item-text-center">Telepon: <?php echo e($data['telepon']); ?></p>
                                    <p class="item-text-center">Keluhan: <?php echo e($data['keluhan']); ?></p>
                                    <p class="item-text-center">Dokter: <?php echo e($data['dokter']); ?></p>
                                    <p class="item-text-center">Tanggal: <?php echo e($data['date']); ?></p>
                                    <p class="item-text-center">Pesan: <br> <?php echo e($data['pesan']); ?></p>
                                    <hr>
...
</html><?php /**PATH D:\Project\rumahsakit\resources\views/email.blade.php ENDPATH**/ ?>